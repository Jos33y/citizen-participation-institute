<?php
$title = "Election Division";
include 'include/dbcon.php';
include 'include/header.php';

$sql = "SELECT * FROM governments WHERE webgroup = 'Election'";
...
<div class="container record-req">
    <h3 class="records-head text-left">The <?php echo $rowcount; ?> Election Division in Illinois
    </h3>
...
$result_count = mysqli_query(
    $con,
    "SELECT COUNT(*) As total_records FROM governments WHERE webgroup = 'Election'"
);
...
$sql = "SELECT * FROM governments WHERE webgroup = 'Election' LIMIT $offset, $total_records_per_page";
