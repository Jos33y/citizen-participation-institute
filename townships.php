...
<div class="container record-req">
    <h3 class="records-head text-left">The <?php echo $rowcount; ?> Townships of Illinois
    </h3>
    ...
    <div class="text-center">
        ...
        <p class="texts"><i>Alexander, Calhoun, Edwards, Hardin, Johnson, Massac, Menard, Monroe, Morgan, Perry,
                Pope, Pulaski, Randolph, Scott, Union, Wabash and Williamson are the 17 counties without townships.</i>
        </p>
    </div>
...
<div class="container">
    <div class="table">
        <table class="table table-bordered text-center">
            ...
            <?php
$sql = "SELECT * FROM governments WHERE webgroup = 'Twp' ORDER BY FullSpan LIMIT 50";
