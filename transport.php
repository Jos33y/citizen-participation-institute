...
$sql = "SELECT * FROM governments WHERE webgroup = 'Transport'";
$result = mysqli_query($con, $sql);
$rowcount = mysqli_num_rows($result);

$sql = "SELECT GovId FROM governments WHERE webgroup = 'Transport'";
...
<div class="container record-req">
    <h3 class="records-head text-left">The <?php echo $rowcount; ?> Transport Districts of Illinois
    </h3>
    <div class="text-center">
        ...
        <p class="texts">​​​Busses, Boats, Planes, in sequence by the headquarters city:</p>
    </div>
</div>
<!-- Table -->
<div class="container">
    <div class="table">
        <table class="table table-bordered text-center">
            ...
            <tbody>
            <?php
$sql = "SELECT GovId, ElectionAuthority FROM governments WHERE webgroup = 'Transport'";
$query = mysqli_query($con, $sql);
while ($row_gov = mysqli_fetch_array($query)) {
    $govid = $row_gov["GovId"];
