...
$sql = "SELECT * FROM governments WHERE webgroup = 'Planning'";
$result = mysqli_query($con, $sql);
$rowcount = mysqli_num_rows($result);

$sql = "SELECT GovId FROM governments WHERE webgroup = 'Planning'";
...
<div class="container record-req">
    <h3 class="records-head text-left">The <?php echo $rowcount; ?> Regional Planning Agency of Illinois
    </h3>
...
WHERE governments.webgroup = 'Planning'
