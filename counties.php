...
$sql = "SELECT * FROM governments WHERE webgroup = 'County'";
...
<div class="container record-req">
    <h3 class="records-head text-left">The <?php echo $rowcount; ?> Counties of Illinois.
    </h3>
...
$result_count = mysqli_query(
    $con,
    "SELECT COUNT(*) As total_records FROM governments WHERE webgroup = 'County'"
);
...
$sql = "SELECT * FROM governments WHERE webgroup = 'County' LIMIT $offset, $total_records_per_page";
