<?php
$title = "Sewerage Districts";
include 'include/dbcon.php';
include 'include/header.php';

$sql = "SELECT * FROM governments WHERE webgroup = 'Sewer'";
$result = mysqli_query($con, $sql);
$rowcount = mysqli_num_rows($result);

$sql = "SELECT GovId FROM governments WHERE webgroup = 'Sewer'";
...
<div class="container record-req">
    <h3 class="records-head text-left">The <?php echo $rowcount; ?> Sewerage Disposal Districts of Illinois
    </h3>
    <div class="text-center">
        ...
        <p class="texts">This is not a list of all the sewerage disposal agencies in Illinois. Many other collections
            are operated as departments of a
            <a href="#">municipal government</a> This is a list of those operated by their own separate governments,
...
<div class="container">
    <div class="table">
        <table class="table table-bordered text-center">
            ...
            <tbody>
            <?php
$sql = "SELECT GovId, ElectionAuthority FROM governments WHERE webgroup = 'Sewer'";
$query = mysqli_query($con, $sql);
while ($row_gov = mysqli_fetch_array($query)) {
    $govid = $row_gov["GovId"];
