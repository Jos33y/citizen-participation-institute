...
$sql = "SELECT * FROM governments WHERE webgroup = 'Park'";
$result = mysqli_query($con, $sql);
$rowcount = mysqli_num_rows($result);

$sql = "SELECT GovId FROM governments WHERE webgroup = 'Park' ORDER BY GovId DESC";
...
<div class="container record-req">
    <h3 class="records-head text-left">The <?php echo $rowcount; ?> Park Districts in Illinois
    </h3>
    <div class="text-center">
        ...
        <p class="texts">​This is not a list of all public park authorities in Illinois. Many other public parks are
            operated as departments of a
            <a href="municipalities.php">municipal government</a> or a <a href="forest-districts.php">forest preserve district.</a> This is a list of those
            operated by their own separate governments, independent of any city, village, town, township or forest
            preserve district.</p>
    </div>
    <br>
...
$result_count = mysqli_query(
    $con,
    "SELECT COUNT(*) As total_records FROM governments WHERE webgroup = 'Park'"
);
...
$sql = "SELECT GovId, ElectionAuthority FROM governments WHERE webgroup = 'Park' LIMIT $offset, $total_records_per_page";

$sql = "SELECT *
FROM governments
INNER JOIN addresses
ON governments.GovId = addresses.GovId
WHERE governments.webgroup = 'Park'
