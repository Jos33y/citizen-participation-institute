<?php
$title = "Multi Townships";
include 'include/dbcon.php';
include 'include/header.php';

$sql = "SELECT * FROM governments WHERE webgroup = 'Assessment'";
$result = mysqli_query($con, $sql);
$rowcount = mysqli_num_rows($result);

$sql = "SELECT GovId FROM governments WHERE webgroup = 'Assessment' ORDER BY GovId DESC";
...
<div class="container record-req">
    <h3 class="records-head text-left">The <?php echo $rowcount; ?> Multi Townships in Illinois
    </h3>
...
$result_count = mysqli_query(
    $con,
    "SELECT COUNT(*) As total_records FROM governments WHERE webgroup = 'Assessment'"
);
...
$sql = "SELECT GovId, ElectionAuthority FROM governments WHERE webgroup = 'Assessment' LIMIT $offset, $total_records_per_page";
$query = mysqli_query($con, $sql);
while ($row_gov = mysqli_fetch_array($query)) {
    $govid = $row_gov["GovId"];
