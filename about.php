    ...
    <div class="container">
        <div class="first-col">
            ...
            <p class="about-para">
                ...
                problems
                <a style="text-decoration: none;" href="open-records-violation-complaint.html" class="link">securing public information</a> or encountering
                <a style="text-decoration: none;" href="open-meetings-violation-form.html" class="link">public meeting violations</a>.
            </p>

            <br>
            <p class="about-para">
                We publish on this website copyrighted lists we have compiled of the
                <a style="text-decoration: none;" href="record-request.php" class="link"> email addresses</a> that citizens can use to
                send Freedom of Information requests to any of the 8,511 units of local government in Illinois.
                It is the only <a style="text-decoration: none;" href="record-request.php" class="link"> complete list</a> of those local
                governments available. We intend to make it possible for a citizen to fill in a request form on our
                website, and it will automatically be emailed to the proper official.
