...
<body>
    ...
    <div class="container">
        <div class="first-col">
            ...
            <h2 class="open-head">The citizens own all the local governments </h2>
            <br>
            <h4 class="open-text"> The citizens, not public officials, are the owners of all the 1,297 municipalities
                (308 cities, 977 villages, and 12 incorporated towns), 1,431 townships, 102 counties, 856 school
                districts,
                39 community colleges, 358 library districts, 828 fire districts, 340 park districts, 115 forest
                preserve,
                conservation, and soil and water districts, 860 drainage districts, 112 sewerage districts,
                21 street lighting districts, 20 mosquito control districts, and hundreds of other public bodies in
                Illinois,
            ...
            <h4 class="open-text"> The owners of anything have a right to know what is going on, and to influence
                decisions being made. Illinois has several "sunshine" laws designed to preserve those owners' rights in
                their local governments.
                Using those rights, owners sometimes request information from officials.</h4>
            <br>
            <h4 class="open-text">
                The Citizen Participation Institute believes that most public officials want to do the right thing,
                but they are not always aware of what is required. We work with local governments to educate them and
                keep them updated so violations don't happen. We work with citizens who need help in those matters.
            ...
            <p class="open-para">
                ...
                defendant's attorney fees and court costs.
            </p>
        </div>
