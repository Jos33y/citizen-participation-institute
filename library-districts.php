...
$sql = "SELECT GovId FROM governments WHERE webgroup = 'Library' ORDER BY GovId DESC";
...
<div class="container record-req">
    <h3 class="records-head text-left">The <?php echo $rowcount; ?>  Public Library and Museum Districts in Illinois
    </h3>
...
$result_count = mysqli_query(
    $con,
    "SELECT COUNT(*) As total_records FROM governments WHERE webgroup = 'Library'"
);
...
$sql = "SELECT GovId, ElectionAuthority FROM governments WHERE webgroup = 'Library' LIMIT $offset, $total_records_per_page";
$sql = "SELECT *
FROM governments
INNER JOIN addresses
ON governments.GovId = addresses.GovId
WHERE governments.webgroup = 'Library'
