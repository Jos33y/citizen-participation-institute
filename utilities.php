...
$sql = "SELECT * FROM governments WHERE webgroup = 'Utilities'";
$result = mysqli_query($con, $sql);
$rowcount = mysqli_num_rows($result);

$sql = "SELECT GovId FROM governments WHERE webgroup = 'Utilities'";
...
<div class="container record-req">
    <h3 class="records-head text-left">The <?php echo $rowcount; ?> Special Utility Agencies of Illinois
    </h3>
    ...
    <br>
    <p class="texts">In sequence by the public body name:​</p>
</div>
<!-- Table -->
<div class="container">
    <div class="table">
...
$result_count = mysqli_query(
    $con,
    "SELECT COUNT(*) As total_records FROM governments WHERE webgroup = 'Utilities'"
);
...
WHERE governments.webgroup = 'Utilities'
ORDER BY addresses.PublicBodyNameFormal ASC
