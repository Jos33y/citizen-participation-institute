...
$sql = "SELECT * FROM governments WHERE webgroup = 'School'";
$result = mysqli_query($con, $sql);
$rowcount = mysqli_num_rows($result);

$sql = "SELECT GovId FROM governments WHERE webgroup = 'School'";
...
<div class="container record-req">
    <h3 class="records-head text-left">The  The <?php echo $rowcount; ?> Public School Districts of Illinois
    </h3>
...
$result_count = mysqli_query(
    $con,
    "SELECT COUNT(*) As total_records FROM governments WHERE webgroup = 'School'"
);
...
$sql = "SELECT GovId, ElectionAuthority FROM governments WHERE webgroup = 'School' LIMIT $offset, $total_records_per_page";
$query = mysqli_query($con, $sql);
while ($row_gov = mysqli_fetch_array($query)) {
    $govid = $row_gov["GovId"];
