...
$sql = "SELECT GovId FROM governments WHERE webgroup = 'Water'";
...
<div class="container record-req">
    <h3 class="records-head text-left">The <?php echo $rowcount; ?> Public Water Districts in Illinois
    </h3>
    <div class="text-center">
        ...
        <p class="texts">This is not a list of all public water suppliers in Illinois. Many other public
            utilities are departments of a
            <a href="municipalities.php">municipal</a> or <a href="counties.php">county</a> government.<br> This is a list of only those operated by
            their own separate governments, independent of any city, village, town, or <a href="townships.php">township</a>.</p>
    </div>
    <br>
...
WHERE governments.webgroup = 'Water'
