...
<div class="container record-req">
    ...
    <div class="text-center">
        ...
        <p class="texts">This is not a list of all public water suppliers in Illinois. Many other public
            ...
            <a href="#">municipal</a> or <a href="#">county</a> government.<br> This is a list of only those operated by
            their own separate governments, independent of any city, village, town, or <a href="#">township</a>.</p>
    </div>
...
<div class="container">
    <div class="table">
        <table class="table table-bordered text-center">
            ...
            <tbody>
            <?php
$sql = "SELECT GovId, ElectionAuthority FROM governments WHERE webgroup = 'Water'";
$query = mysqli_query($con, $sql);
while ($row_gov = mysqli_fetch_array($query)) {
    $govid = $row_gov["GovId"];
